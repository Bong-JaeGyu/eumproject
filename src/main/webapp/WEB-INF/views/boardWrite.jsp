...
<%-- 	<%=session.getAttribute("id")%>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>멘토게시판<span class="m_1">글작성</span></h1>
		</div>
	</div>
	...
	<div id="writedit" class="section wb">
        <div class="container">
   <input type="text" id="boardtitle" style="width: 100%" placeholder="   게시글 제목">
            <div class="section-title text-center">
                ...
                <div>
	<button style="" onclick="writego()" class="btn btn-light btn-radius btn-brd grd1">
										작성하기
									</button>
...
<script>
		...
		function writego () {
			...
			axios.get('writego.do',{
				params : {
					boardtitle : document.getElementById("boardtitle").value ,
					boardcontent : CKEDITOR.instances.editor1.getData()
