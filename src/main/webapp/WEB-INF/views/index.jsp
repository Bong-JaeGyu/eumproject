							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>이음</strong> 진로 멘토링</h2>
										<p class="lead"> 이음은 장소에 제약없이 다양한 직업군 ,대학생을 멘토로하여 학생들과 온라인으로 연결해주어 학생들로 하여금 다양한 직업군이나 대학생 <br>멘토들에게 정보를 얻어 자신의 진로를 형성하는데 도움을 주는 사이트입니다. </p>
											<a href="#" class="hover-btn-new"><span>가입하기</span></a>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="#" class="hover-btn-new"><span>자세히 보기</span></a>
									</div>
								</div>
							</div><!-- end row -->            
						</div><!-- end container -->
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4>갑부중에 갑</h4>
                        <h2>빌게이츠</h2>
                        <p>윌리엄 헨리 "빌" 게이츠 3세(영어: William Henry "Bill" Gates III, 1955년 10월 28일 ~ )는 미국의 마이크로소프트 설립자이자, 기업인이다.</p>

                        <p>저는 "아빠, 나는 언젠간 학교에 돌아갈 것이고 졸업장을 받을 거라고 항상 말했었잖아요."라는 이 말을 하기 위해 30년 이상을 기다려왔습니다. 잠시 생각해보십시오. 여러분이 일주일에 몇 시간 혹은 한 달에 몇 달러를 어딘가 기부하기 위한 준비가 되어 있고 또한 당신이 그 시간이나 돈이 어딘가에서 생명을 구하고 삶의 질을 극적으로 개선할 수 있는 곳에 사용되기 원한다면 그곳은 어디일까요? 아직 저는 낙관론자입니다. 불평등은 우리와 영원히 함께 있을 것입니다. 그러나 복잡성을 무너뜨리는 새로운 방법들은 이제 나온 것들이며 그 방법들은 우리가 우리의 관심을 극대화할 수 있도록 도와줄 것입니다. 그리고 그로 인해 앞으로의 미래는 과거와는 다를 것입니다. </p>
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="images/recommend01.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
			</div>
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="images/recommend02.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4>축구 잘하는 우리형</h4>
                        <h2>호날두</h2>
                        <p>UEFA 챔피언스 리그와 레알 마드리드 역사상 최다 득점자이자 현역 선수 중 최다 득점자이며, 발롱도르 최다 수상자[22]로 리오넬 메시와 함께 21세기 세계 축구계를 양분하고 있는 축구 역사상 최고의 선수 중 한 명이다.</p>

                        <p>호날두는 전설적인 선수이며, 축구 역사상 최고의 선수이다. 호날두는 아틀레티코전에서 그것을 증명해보였다. 마치 외계인 같다. 레알 마드리드는 호날두 없이는 많은 업적을 세우지 못했을 것이다. 호날두는 이제 유벤투스에서 역사를 써내려가고 있다."</p>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-item">
						...
						<div class="meta-info-blog">
							<span><i class="fa fa-calendar"></i> <a href="#">May 02, 2019</a> </span>
                            <span><i class="fa fa-tag"></i>  <a href="#">News</a> </span>
                            <span><i class="fa fa-comments"></i> <a href="#">12 Comments</a></span>
						</div>
						<div class="blog-title">
							<h2><a href="#" title="">눈술 준비를 위한 A-Z</a></h2>
						</div>
						<div class="blog-desc">
							<p >눈술 준비를 위한 A-Z 논술의 기본. 1. 논술에 대한 마인드 / 2. 논술의 핵심 원리 / 3. 논술을 준비하는 방법﻿ / 4. 논술 시험장에서. 말로만 들었는데, 막상 겪으니 정말 '멘붕'이 오는군요....</p>
						</div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i> 해커X 영어강사</h3>
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i> 서울대 국문학과3학년</h3>
                                <p class="lead">서울대 국문학과 3학년 학생입니다. 서울대에 관해 궁금한게 있으면 무엇이든 물어보세요</p>
                            </div>
                            <!-- end testi-meta -->
                        </div>
                        <!-- end testimonial -->
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="desc">
                                <h3><i class="fa fa-quote-left"></i>세브란스병원 간호사</h3>
                            ...
                            <div class="row text-center">
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-space"></div> <img src="images/info1.png" alt="">
                                ...
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-space"></div> <img src="images/info2.png" alt="">
                                        <!-- <div class="pricing-table-features" >
                                ...
                                <div class="col-md-4">
                                    <div class="pricing-table pricing-table-highlighted">
                                        ...
                                        <div class="pricing-table-space"></div> <img src="images/info3.png" alt="">
                                        <!-- <div class="pricing-table-features" >
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-center">                   
                    <p class="footer-company-name">All Rights Reserved. &copy; 2019 <a href="#">이음</a> Design By : <a href="https://html.design/">BONG JAEGYU</a></p>
                </div>
            </div>
        </div><!-- end container -->
    </div><!-- end copyrights -->
